...
-- Основные типы задач
('Bug', './icons/bug-48.png', '#E74C3C'),                       -- Красный для багов
('Task', './icons/task-48.png', '#343fdbff'),                   -- Синий для задач
('Story', './icons/story-50.png', '#15a14fff'),                 -- Зелёный для историй
('Epic', './icons/epic-48.png', '#842ba7ff'),                   -- Фиолетовый для эпиков
('Sub-task', './icons/task-48.png', '#ff9d00ff'),               -- Оранжевый для подзадач
('Improvement', './icons/improvement-50.png', '#16c09eff'),     -- Бирюза для улучшений
('Documentation', './icons/documentation-48.png', '#34495E');   -- Тёмно-серый для документации
